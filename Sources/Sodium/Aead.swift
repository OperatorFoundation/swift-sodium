...
extension Aead {
    ...
    public struct ChaCha20Poly1305Ietf {
        public let ABytes = Int(crypto_aead_chacha20poly1305_ietf_abytes())
        public typealias MAC = Bytes
    }
}
...
extension Aead.ChaCha20Poly1305Ietf: NonceGenerator {
    public typealias Nonce = Bytes
    public var NonceBytes: Int { return Int(crypto_aead_chacha20poly1305_ietf_npubbytes()) }
}

extension Aead.ChaCha20Poly1305Ietf: SecretKeyGenerator {
    public var KeyBytes: Int { return Int(crypto_aead_chacha20poly1305_ietf_keybytes()) }
    public typealias Key = Bytes
    
    public static var keygen: (UnsafeMutablePointer<UInt8>) -> Void = crypto_aead_chacha20poly1305_ietf_keygen
}
